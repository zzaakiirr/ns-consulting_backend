...
"""
Django settings for ns_consulting project.
...
SECRET_KEY = 'h4o%7dvrcth-j1zu(nx(**@_!h35jlr4#)2iy7qghh7gi#1&qv'
...
ROOT_URLCONF = 'ns_consulting.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'ns_consulting', 'templates'),],
        'OPTIONS': {
            'context_processors': [
...
CMS_TEMPLATES = (
    ...
    ('left_and_right_save.html', 'Блоки слева и справа'),
)
